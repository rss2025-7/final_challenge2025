...
class HomographyTransformer(Node):
    def __init__(self):
        ...
        self.cone_pub = self.create_publisher(ConeLocation, "/relative_banana", 10)
        self.marker_pub = self.create_publisher(Marker, "/cone_marker", 1)
        self.cone_px_sub = self.create_subscription(ConeLocationPixel, "/relative_banana_px", self.cone_detection_callback, 1)
